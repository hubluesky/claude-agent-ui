...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="px-1.5 py-0.5 rounded hover:bg-[#242320] transition-colors cursor-pointer"
      title={isDark ? '切换到浅色主题' : '切换到深色主题'}
    >
      {isDark ? (
        <svg className="w-3.5 h-3.5 text-[#7c7872]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
