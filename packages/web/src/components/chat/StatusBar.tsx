...
export function StatusBar() {
  ...
  const modeLabel = { default: 'Ask', acceptEdits: 'Edit', plan: 'Plan', bypassPermissions: 'Bypass', dontAsk: 'Auto' }
  ...
  return (
    <div className="h-10 flex items-center gap-3 px-10 border-t border-[#3d3b37] relative">
      <div className={`w-2 h-2 rounded-full ${config.color} ${'pulse' in config && config.pulse ? 'animate-pulse' : ''}`} />
